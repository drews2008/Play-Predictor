// src/components/defense/FrontTable.tsx
...
const FrontTable: React.FC<Props> = ({ hash, data, totals }) => {
  return (
    <div className="mt-4">
      <h4 className="font-semibold mb-2 text-center">{hash} Hash – Front</h4>
      <table className="min-w-full border text-sm">
        <thead className="bg-blue-600 text-white">
          <tr>
            <th className="border px-2 py-1 text-left">Situation</th>
            <th className="border px-2 py-1 text-left">Top Front</th>
          </tr>
        </thead>
        <tbody>
          {situationOrder
